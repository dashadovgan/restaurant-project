  ...
  <div class="reservation-container">
    ...
    <div v-if="!formSubmitted">
      ...
      <form @submit.prevent="handleSubmit" class="res-form">
        ...
        <AppButton type="submit" width="100%">Send Message</AppButton>
      </form>
    </div>
    ...
    <div v-else class="thank-card-wrapper">
      ...
      <ThankYouCard :transaction-id="transactionId" :date="form.date" :total="totalPrice" />
    </div>
  </div>
</template>
...
import { calculateTotal, generateTransactionId } from "@/services/reservation.service";
...
const totalPrice = computed(() => {
  return calculateTotal(form.guests)
});
