<template>
  <section class="team-section">
    <div class="team-header">
      ...
      <p>
        Leading our kitchen is Chef Julien Moreau, whose expertise and vision
        elevate every dish on our menu. With over 15 years of experience in fine
        dining, Chef Julien draws inspiration from French countryside traditions
...
@media (max-width: 768px) {
  ...
  .team-grid {
    grid-template-columns: 1fr;
    /* карточки шефов вертикально */
    gap: 20px;
  }

  .team-section {
    width: 80%;
    /* немного меньше от края экрана */
    padding: 50px 0;
  }
