  ...
  <section class="privacy-policy-section">
    <div class="privacy-policy">
      ...
      <p class="privacy-intro">
        At Platieu, we are committed to protecting the privacy and security of
        our customers and website visitors. This Privacy Policy describes how we
        collect, use, and handle your personal information when you access our
        services, including through our website and any affiliated platforms.
        <br />
      ...
      <div class="privacy-section">
        ...
        <ul class="section-list">
          ...
          <li>
            Payment confirmation (upload of transfer receipt or deposit proof)
          </li>
        </ul>
        ...
        <ul class="section-list">
          ...
          <li>Device type</li>
          <li>
            Referral URLs and on-site interactions (pages visited, clicks, etc.)
          </li>
      ...
      <div class="privacy-section">
        ...
        <p class="section-desc">We use the information collected to:</p>
        <ul class="section-list">
      ...
      <div class="privacy-section">
        ...
        <ul class="section-list">
          ...
          <li>
            IT and hosting partners (to maintain and operate our website).
          </li>
          <li>
            Legal authorities when required by law or to defend against legal
            claims.
          </li>
        </ul>
      </div>
      ...
      <div class="privacy-section">
        ...
        <p class="section-desc">
          Despite these measures, no digital system is 100% secure. Users should
          always protect their devices and logins.
        </p>
      </div>
      <!-- Раздел 5 -->
      <div class="privacy-section">
        <h2 class="section-title">5. Your Rights</h2>
        <p class="section-desc">As a user, you have the right to:</p>
        <ul class="section-list">
        ...
        <p class="section-desc">
          ...
          <strong>privacy@platieu.com.</strong>
        </p>
      </div>
      <!-- Раздел 6 -->
      <div class="privacy-section">
        <h2 class="section-title">6. Cookies</h2>
        <p class="section-desc">We use cookies to:</p>
        <ul class="section-list">
      ...
      <div class="privacy-section">
        ...
        <p class="section-desc">
          ...
          law, technology, or our services. Updates will be posted on this page
      ...
      <div class="privacy-section">
        ...
        <p class="section-desc">
          ...
          contact us at: Platieu Customer Support <br />Email:
          <strong>contact@platieu.com</strong> <br />
          Phone: <strong>+33 1 23 45 67 89</strong>
        </p>
      </div>
    </div>
  </section>
